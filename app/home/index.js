import {
  ...
  const index = () => {
    ...
    const fetchHabits = async () => {
      try {
        const response = await axios.get("http://172.16.151.83:3000/habitslist");
    ...
    const handleCompletion = async () => {
      try {
        ...
        await axios.put(`http://172.16.151.83:3000/habits/${habitId}/completed`, {
    ...
    const deleteHabit = async () => {
      try {
        ...
        const response = await axios.delete(
          `http://172.16.151.83:3000/habits/${habitId}`
        );
